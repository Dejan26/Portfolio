...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "14f56278-c131-4f23-b542-52b81be65688");
  ...
  return (
    <motion.div
      ...
      <motion.form
        ...
        <div className='grid grid-cols-mojgrid gap-6 mt-10 mb-8'>
          <motion.input
        ...
        <motion.textarea
          ...
          rows='6' placeholder='Enter your message' required className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='message'></motion.textarea>
