  ...
  return (
    ...
    >
      <motion.h4
        ...
        className='text-center mb-2 text-lg dont-ovo'>Introduction</motion.h4>
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        ...
        <motion.div
          ...
          <Image src={assets.jaPlava} alt='user' className='w-full rounded-3xl' />         
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          ...
          <p className='mb-10 max-w-2xl font-ovo'>
            I finished the one-year ITAcademy frontend course.<br />
            Full stack training at the programming company ENON Solutions, where I completed a quiz project (link is in projects).
          </p>
          ...
          <motion.ul
            ...
            {infoList.map((item, index) => {
             ...
             return (  
              <motion.li
                onClick={isLast ? () => window.location.href = "#work" : undefined}
